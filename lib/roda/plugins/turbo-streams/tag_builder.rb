  ...
  module Streams
    class TagBuilder
      ...
      def action(name, target, content = nil, **rendering, &block)
        template = render_template(target, content,
                                   **rendering, &block)
      ...
      def action_all(name, targets, content = nil, **rendering, &block)
        template = render_template(targets, content,
                                   **rendering, &block)
      ...
      # TODO: support more flexible rendering params?
